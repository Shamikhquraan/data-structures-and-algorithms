...
const sortByChildren = (charArray) => {
  let sorted= charArray.sort((a,b)=> a.children.length-b.children.length)
  return sorted;
};
...
const citiesAtoJ = (arr) => {
  let x = arr.filter(city => /^[A-J]/g.test(city));
  return x;};
